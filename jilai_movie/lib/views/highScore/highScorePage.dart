...
import 'package:jilai_movie/modle/high_score_page_model.dart';
import 'package:jilai_movie/modle/entity/lastest_new_page_entity.dart';

class HighScorePage extends StatefulWidget {

  @override
  State<StatefulWidget> createState() => new HighScorePageState();

}

class HighScorePageState extends State<HighScorePage> with AutomaticKeepAliveClientMixin{

  List<Movies> movies = new List();

  void initData() async {
    lastestNewPageEntity entity = await highScorePageModel().getSectionModle();
    setState(() {
